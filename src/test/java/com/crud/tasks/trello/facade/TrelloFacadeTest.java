...
public class TrelloFacadeTest {
    ...
    @Test
    void shouldReturnEmptyList_WhenTrelloServiceReturnsEmptyList() {
        // Given
        List<TrelloListDto> trelloLists = Collections.emptyList();
        List<TrelloBoardDto> trelloBoards = Collections.emptyList();
        when(trelloService.fetchTrelloBoards()).thenReturn(trelloBoards);
        when(trelloMapper.mapToBoards(trelloBoards)).thenReturn(Collections.emptyList());
        when(trelloMapper.mapToBoardsDto(Collections.emptyList())).thenReturn(Collections.emptyList());
        when(trelloValidator.validateTrelloBoards(Collections.emptyList())).thenReturn(Collections.emptyList());
    ...
    @Test
    void shouldHandleNullFromTrelloService() {
        // Given
